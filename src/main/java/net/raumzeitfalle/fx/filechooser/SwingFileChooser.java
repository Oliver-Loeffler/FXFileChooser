...
public class SwingFileChooser extends JFXPanel implements HideableView {
	 ...
	 * File browsing will start in current working directory.
	 * 
	 * @param skin         {@link Skin} Defines the visual appearance of
	 *                     FileChooser. Defaults to dark skin.
	 * @param filter       {@link PathFilter} argument of variable length, accepts
	 *                     all path filters as needed. In case no filter is
	 *                     provided, a filter accepting all files will be used.
	 ...
	 * @param skin         {@link Skin} Defines the visual appearance of
	 *                     FileChooser. Defaults to dark skin.
	 * @param title        {@link String} title of the {@link FileChooser} view. In
	 *                     case of having the JavaFX based {@link DirectoryChooser}
	 *                     configured, the window titles for the directory and file
	 *                     choosers will be identical.
	 * @param filter       {@link PathFilter} argument of variable length, accepts
	 *                     all path filters as needed. In case no filter is
	 *                     provided, a filter accepting all files will be used.
	 * @return A configured {@link SwingFileChooser}.
	 ...
	 *                     configured, the window titles for the directory and file
	 *                     choosers will be identical.
	 * @param pathToBrowse {@link Path} Location to start file browsing in. If the
	 *                     argument is null or the denoted location does not exist,
	 *                     the control will default to current working directory.
	 * @param filter       {@link PathFilter} argument of variable length, accepts
	 *                     all path filters as needed. In case no filter is
	 *                     provided, a filter accepting all files will be used.
	 * @return A configured {@link SwingFileChooser}.
	 ...
	 * @param dirChooserTitle {@link String} title of the {@link DirectoryChooser}
	 *                        view when enabled. By default, the same title is used
	 *                        as for the {@link FileChooser} view.
	 * @param pathToBrowse    {@link Path} Location to start file browsing in. If
	 *                        the argument is null or the denoted location does not
	 *                        exist, the control will default to current working
	 *                        directory.
	 * @param filter          {@link PathFilter} argument of variable length,
	 *                        accepts all path filters as needed. In case no filter
	 *                        is provided, a filter accepting all files will be
	 *                        used.
	 * @return A configured {@link SwingFileChooser}.
	 */
	public static SwingFileChooser create(Skin skin, String title, String dirChooserTitle, String pathToBrowse,
			PathFilter... filter) {
