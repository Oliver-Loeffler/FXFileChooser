...
class FileUpdateServiceTest extends ApplicationTest {
	...
	void removeShutDownHook() throws Exception {
		...
		FileUpdateService serviceUnderTest = new FileUpdateService(Paths.get("./"), FXCollections.observableArrayList());
		
		boolean wasRemovedProperly = Runtime.getRuntime()
											.removeShutdownHook(serviceUnderTest.getShutdownThread());
